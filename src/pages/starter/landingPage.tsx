              ...
              {[
                {
                  ...
                  desc: "Develop clear roadmaps that align leadership vision with operational execution.",
                },
                {
                  title: "Operations Optimization",
                  desc: "Improve efficiency, reduce waste, and increase profitability across departments.",
                },
                {
                  title: "Financial Advisory",
                  desc: "Drive data-informed decisions with strong financial modeling and forecasting.",
                },
              ].map((service) => (
                <motion.div
                  key={service.title}
